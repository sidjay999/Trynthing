...
# DensePose import is deferred to AutoMasker.__init__ to avoid
# fvcore/detectron2 crash on Windows
...
class AutoMasker:
    def __init__(
        ...
        from model.DensePose import DensePose  # Lazy import for Windows compat
